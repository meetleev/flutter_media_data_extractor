...
struct MediaDataSource {
  ...
  static func fromList(_ __pigeon_list: [Any?]) -> MediaDataSource? {
    let type = __pigeon_list[0] as! MediaDataSourceType
    let url = __pigeon_list[1] as! String
    let packageName: String? = nilOrValue(__pigeon_list[2])
...
struct VideoTrackData {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> VideoTrackData? {
    let frameRate: Double? = nilOrValue(__pigeon_list[0])
    let width: Double? = nilOrValue(__pigeon_list[1])
    let height: Double? = nilOrValue(__pigeon_list[2])
    let bitRate: Double? = nilOrValue(__pigeon_list[3])
    let duration: Int64? = isNullish(__pigeon_list[4]) ? nil : (__pigeon_list[4] is Int64? ? __pigeon_list[4] as! Int64? : Int64(__pigeon_list[4] as! Int32))
...
struct VideoMetaData {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> VideoMetaData? {
    let artist: String? = nilOrValue(__pigeon_list[0])
    let title: String? = nilOrValue(__pigeon_list[1])
    let album: String? = nilOrValue(__pigeon_list[2])
    let genre: String? = nilOrValue(__pigeon_list[3])
    let language: String? = nilOrValue(__pigeon_list[4])
    let author: String? = nilOrValue(__pigeon_list[5])
    let date: String? = nilOrValue(__pigeon_list[6])
...
struct VideoData {
  ...
  // swift-format-ignore: AlwaysUseLowerCamelCase
  static func fromList(_ __pigeon_list: [Any?]) -> VideoData? {
    let meta: VideoMetaData? = nilOrValue(__pigeon_list[0])
    let tracks = __pigeon_list[1] as! [VideoTrackData?]
...
private class messagesPigeonCodecReader: FlutterStandardReader {
  override func readValue(ofType type: UInt8) -> Any? {
    ...
    case 133:
      var enumResult: MediaDataSourceType? = nil
      let enumResultAsInt: Int? = nilOrValue(self.readValue() as? Int)
      if let enumResultAsInt = enumResultAsInt {
        enumResult = MediaDataSourceType(rawValue: enumResultAsInt)
      }
      return enumResult
    default:
...
private class messagesPigeonCodecWriter: FlutterStandardWriter {
  override func writeValue(_ value: Any) {
    if let value = value as? MediaDataSource {
      ...
      super.writeByte(132)
      super.writeValue(value.toList())
    } else if let value = value as? MediaDataSourceType {
      super.writeByte(133)
