...
class MediaDataSource {
  ...
  MediaDataSource(this.type, this.url, {this.packageName});
}
...
@ConfigurePigeon(
  PigeonOptions(
    ...
    kotlinOut:
        'android/src/main/kotlin/com/skyza/media_data_extractor/Messages.g.kt',
    kotlinOptions: KotlinOptions(package: 'com.skyza.media_data_extractor'),
  ),
)
@HostApi()
